...
public class FoodController {
	...
	public ResponseEntity<?> addFood(@RequestBody FoodSpecificRequest foodReq) throws AccountExistsException {
	...
	@PreAuthorize("hasRole('ROLE_ADMIN')")
	public ResponseEntity<?> updateFood(@PathVariable long foodId, @RequestBody FoodSpecificRequest foodReq)
