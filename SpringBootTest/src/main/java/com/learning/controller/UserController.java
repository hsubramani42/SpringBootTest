...
public class UserController {
	...
	public ResponseEntity<?> addUser(@Valid @RequestBody UserRegisterRequest userReq) throws AccountExistsException {
		...
		User user = new User(userReq.getEmail(), userReq.getName(), passwordEncoder.encode(userReq.getPassword()), address, roles);
	...
	public ResponseEntity<?> authenticate(@Valid @RequestBody UserRegisterRequest userReq) throws AuthenticationException {
	...
	public ResponseEntity<?> updateUser(@PathVariable long userId, @Valid @RequestBody UserRegisterRequest userReq)
		...
		User user = new User(userReq.getEmail(), userReq.getName(), userReq.getPassword(), address,
